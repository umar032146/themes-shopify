...
import laptop2 from '../images/laptop8.webp';
import mobile2 from '../images/phone8.avif';
import laptop3 from '../images/laptop7.webp';
import mobile3 from '../images/phone7.avif';
      ...
      <div className="buttons">
        {templates.map((template, index) => (
          <div
            ...
            style={{ backgroundColor: index === 0 ? '#e1e2e3' : index === 1 ? '#515152' : '#030303' }}
          ></div>
        ))}
      </div>
      </div>
